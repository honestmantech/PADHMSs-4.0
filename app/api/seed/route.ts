...
export async function GET() {
  try {
    ...
    // Create admin user with a fixed password hash
    // Using a fixed hash ensures the password will always be "admin123"
    ...
    return NextResponse.json({
      ...
      data: {
        ...
        adminPassword: "admin123", // Include the plain text password in the response
